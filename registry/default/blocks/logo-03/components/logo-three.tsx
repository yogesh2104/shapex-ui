        ...
        <div className="grid lg:grid-cols-3">
          <div className="lg:col-span-1 text-center lg:text-left">
            ...
            <p className="mt-4 text-lg">
              Join thousands of organizations that rely on our solutions to elevate 
              their business. From startups to enterprises, we help everyone achieve 
              their goals with cutting-edge technology.
            </p>
            <Button
              variant="outline"
