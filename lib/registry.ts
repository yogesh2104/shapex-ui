...
//     for (const style of Object.values(Index)) {
        
//       if (style[name]?.component) {
//         return style[name].component;
//       }
//     }
//     throw new Error(`Component with name "${name}" not found in registry.`);
// }
